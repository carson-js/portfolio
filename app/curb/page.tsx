export default function Curb() {
  return (
    <main style={{ fontFamily: "'Georgia', serif" }} className="min-h-screen bg-zinc-950 text-zinc-50">

      {/* Nav */}
      <nav className="max-w-5xl mx-auto px-6 py-6 flex items-center justify-between">
        <a href="/" className="text-sm text-zinc-500 hover:text-zinc-300 transition-colors">← carsonjs.me</a>
        <span className="text-sm font-medium tracking-widest text-zinc-500 uppercase" style={{ fontFamily: "system-ui" }}>Curb</span>
      </nav>

      {/* Hero */}
      <section className="max-w-5xl mx-auto px-6 pt-20 pb-32 text-center">
        <div className="inline-block mb-6 px-3 py-1 rounded-full border border-zinc-700 text-xs text-zinc-500 tracking-widest uppercase" style={{ fontFamily: "system-ui" }}>
          iOS App
        </div>
        <h1 className="text-6xl font-bold leading-tight mb-6 text-zinc-50" style={{ letterSpacing: "-0.03em" }}>
        ...
        <button
          disabled
          className="px-6 py-3 rounded-full bg-zinc-800 text-zinc-500 text-sm cursor-not-allowed border border-zinc-700"
      ...
      <section className="max-w-5xl mx-auto px-6 pb-32">
        <p className="text-xs tracking-widest uppercase text-zinc-600 mb-16 text-center" style={{ fontFamily: "system-ui" }}>Features</p>

        {/* Effortless Logging */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-32">
          <div>
            <span className="text-xs tracking-widest uppercase text-amber-500 mb-4 block" style={{ fontFamily: "system-ui" }}>Fuel & Service</span>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl aspect-[4/3] flex items-center justify-center">
            <span className="text-zinc-700 text-sm" style={{ fontFamily: "system-ui" }}>Screenshot coming soon</span>
          </div>
        </div>

        {/* AI Receipt Scanning */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-32">
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl aspect-[4/3] flex items-center justify-center md:order-first order-last">
            <span className="text-zinc-700 text-sm" style={{ fontFamily: "system-ui" }}>Screenshot coming soon</span>
          </div>
          <div>
            <span className="text-xs tracking-widest uppercase text-amber-500 mb-4 block" style={{ fontFamily: "system-ui" }}>Apple Intelligence</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-32">
          <div>
            <span className="text-xs tracking-widest uppercase text-amber-500 mb-4 block" style={{ fontFamily: "system-ui" }}>Reminders</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-32">
          ...
          <div>
            <span className="text-xs tracking-widest uppercase text-amber-500 mb-4 block" style={{ fontFamily: "system-ui" }}>EV Ready</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-32">
          <div>
            <span className="text-xs tracking-widest uppercase text-amber-500 mb-4 block" style={{ fontFamily: "system-ui" }}>Map View</span>
      ...
      <section className="border-t border-zinc-800 py-32">
        <div className="max-w-5xl mx-auto px-6">
          <p className="text-xs tracking-widest uppercase text-zinc-600 mb-4 text-center" style={{ fontFamily: "system-ui" }}>Under the Hood</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.label} className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
                <div className="w-2 h-2 rounded-full bg-amber-500 mb-4" />
                <h3 className="font-semibold text-zinc-100 mb-2" style={{ fontFamily: "system-ui" }}>{item.label}</h3>
      ...
      <section className="border-t border-zinc-800 py-32">
        <div className="max-w-5xl mx-auto px-6">
          <p className="text-xs tracking-widest uppercase text-zinc-600 mb-4 text-center" style={{ fontFamily: "system-ui" }}>Privacy</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.label} className="border border-zinc-800 rounded-2xl p-6">
                <h3 className="font-semibold text-zinc-100 mb-2" style={{ fontFamily: "system-ui" }}>{item.label}</h3>
                <p className="text-sm text-zinc-500 leading-relaxed" style={{ fontFamily: "system-ui" }}>{item.desc}</p>
              </div>
            ))}
      ...
      <footer className="border-t border-zinc-800 py-12">
        <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-zinc-600" style={{ fontFamily: "system-ui" }}>© 2026 Carson Smith. Built in San Jose.</p>
          <div className="flex gap-6">
            <a href="mailto:support@carsonjs.me" className="text-sm text-zinc-600 hover:text-zinc-300 transition-colors" style={{ fontFamily: "system-ui" }}>
              support@carsonjs.me
            </a>
            <a href="/curb/privacy" className="text-sm text-zinc-600 hover:text-zinc-300 transition-colors" style={{ fontFamily: "system-ui" }}>
              Privacy Policy
            </a>
          </div>
        </div>
